...
const SignInForm = () => {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    ...
    if (userDetailStr) {
      try {
        ...
        const isCompanyProfileEmpty =
          Array.isArray(userDetail.company_profile) &&
          userDetail.company_profile.length === 0;
  ...
  return (
    <GoogleOAuthProvider clientId={clientId}>
      <div
        className="p-[1px] md:mt-0 mt-12 mb-16 rounded-xl md:bg-gradient-to-br from-[#FF3C3C]  to-[#3C00FF]  md:w-[528px]

"
      >
        <div className="sign-in-form relative rounded-xl bg-[#23242B] md:p-14 w-full mx-auto">
