...
const ReportSection = ({ report, markdownComponents, headers, dataRows, exportPopup, handleExportClick, exportPopupRef, closeExportPopup, chatContent, handleCitationClick }) => {
                            ...
                            <table className="w-full border-collapse">
                                <thead>
                                    <tr className="border-b border-b-gray-42 bg-gray-2d">
                                        {headers.map((header, idx) => (
                                            <th
                                                key={idx}
                                                className={`py-3.5 px-3 text-left ${idx === 0
                                ...
                                <tbody>
                                    {dataRows.map((cols, i) => (
                                        <tr
                                            key={i}
                                            className={`text-sm ${i !== dataRows.length - 1 ? "border-b border-b-gray-5c" : ""
                                                }`}
                                        >
                                            <td className="py-2.5 px-3 relative border-r border-gray-5c rounded">
                                                {cols[0]}
                                            </td>
                                            <td className="py-2.5 px-3 relative rounded">{cols[1]}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
