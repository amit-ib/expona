...
import { copyToClipboard, exportToPdf } from "../../utils.js";
const ReportSection = ({
  report,
  markdownComponents,
  headers,
  ...
  return (
    <div className="">
                  ...
                  <thead>
                    <tr className="border-b border-b-gray-42 bg-gray-2d">
                      {headers.map((header, idx) => (
                        <th
                          key={idx}
                          className={`py-3.5 px-3 text-left text-white ${
                            idx === 0
      ...
      {Questions && Questions.questions && (
        <>
          <div className="mb-4 relative group" id="questions">
            <div className="flex mb-4 mt-6 items-center">
      ...
      <div className="border-b border-gray-42 pb-6 flex justify-end">
        <button
