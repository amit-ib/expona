  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4">
        <span className="font-lexend font-light text-xs leading-[1.25] text-white/80 text-right bg-gray-24 px-4 py-2 rounded-full">{matched_criteria} out of {total_criteria} matched</span>
      </div>
    </div>
  );
};
