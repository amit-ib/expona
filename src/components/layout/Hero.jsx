...
const Hero = ({ setProjectsVisibility }) => {
  ...
  return (
    <div className="container mx-auto lg:px-20 px-5 text-center lg:text-left flex items-center justify-center lg:justify-between min-h-[calc(100dvh-88px)]">
      <div className="max-w-screen-sm flex flex-col items-start gap-10">
        <h1 className="text-4xl !leading-[120%] md:text-5xl lg:text-[56px] text-white font-normal ">
          {" "}
          Tenders don't have <br />
          to be confusing.
        </h1>
        <p className="text-lg md:text-xl text-white font-light max-w-[737px] !leading-[160%]">
          Ask questions, find key info, and decide faster
          <br /> with the help of AI.
        </p>
        <div>
          <button
            onClick={() => {
      ...
      <div className="animate-bg relative hidden lg:block">
        <Lottie
